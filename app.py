...
VOUCHER_MESSAGES = [
    "축하합니다. 오늘의 3000 Will에 당첨되었습니다. 기분 좋게 하루를 시작해 보세요.",
    "좋은 기운이 도착했습니다. 3000 Will 당첨입니다!",
    "오늘의 출근 운이 강하네요. 3000 Will을 받았습니다."
]
...
def choose_result():
    ...
    if kind == "voucher":
        ...
        return {
            ...
            "claim_code": f"WL-{datetime.now().strftime('%Y%m%d')}-{claim_suffix}",
        }
